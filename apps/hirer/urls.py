...
urlpatterns = [
    ...
    path(
        "profile/picture/",
        HirerProfilePictureView.as_view(),
        name="hirer-profile-picture",
    ),
    path(
        "settings/notifications/",
        HirerNotificationSettingsView.as_view(),
        name="hirer-notification-settings",
    ),
    path(
        "change-password/",
        HirerChangePasswordView.as_view(),
        name="hirer-change-password",
    ),
]
