...
class TestGeneralRegistration:
    REGISTER_URL = "/api/v1/auth/register/general/"

    def test_register_general_success(self, api_client):
        data = {
            "full_name": "John Doe",
    ...
    def test_register_general_otp_email_sent(self, api_client):
        data = {
            "full_name": "OTP Test",
...
class TestProviderRegistration:
    REGISTER_URL = "/api/v1/auth/register/provider/"

    def test_register_provider_success(self, api_client):
        data = {
        ...
        assert response.status_code == status.HTTP_201_CREATED
        assert response.data["success"] is True
        assert response.data["data"]["email"] == "provider@example.com"
        ...
        assert user.provider_profile.business_name == "Clean Co."
        assert user.provider_profile.service_category == "Cleaning"
        assert user.provider_profile.address == "456 Main St"

    def test_register_provider_phone_validation(self, api_client):
        data = {
            "full_name": "Bad Phone",
    ...
    def test_register_provider_without_phone(self, api_client):
        data = {
            "full_name": "No Phone",
    ...
    def test_register_provider_duplicate_phone(self, api_client):
        data1 = {
            "full_name": "Provider One",
    ...
    def test_register_provider_optional_profile_fields(self, api_client):
        data = {
            "full_name": "Minimal Provider",
    ...
    def test_register_provider_phone_normalization(self, api_client):
        data = {
